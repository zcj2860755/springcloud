...
public class CodeGenerator {
    //JDBC配置，请修改为你项目的实际配置
    private static final String JDBC_URL = "jdbc:mysql://rm-bp138y5rq628s790h4o.mysql.rds.aliyuncs.com:3306/xzdev?useUnicode=true&characterEncoding=UTF-8&autoReconnect=true&serverTimezone=GMT";
    private static final String JDBC_USERNAME = "xizang";
