...
//        System.out.println(json.get("data"));
        ...
        String s = HttpUtil.sendGet("http://restapi.amap.com/v3/geocode/regeo?key=c7f9ff065d022ad4d3f015f147ccc426&location=", "120.127647"+","+"30.281712");
        System.out.println(s);
        Object parse = JSON.parse(s);
        JSONObject jsonObject = JSON.parseObject(s);
        String name=jsonObject.getString("regeocode");
        System.out.println("+++++++++++++++++++");
        System.out.println(name);
        String addressComponent = JSON.parseObject(name).getString("addressComponent");
