...
import static com.zdzc.core.ProjectConstant.*;
...
public class CodeGenerator {
    ...
    public static void genModelAndMapper(String tableName, String modelName) {
        ...
        javaModelGeneratorConfiguration.setTargetProject(PROJECT_PATH +COMMONPROJECT+ JAVA_PATH);
        javaModelGeneratorConfiguration.setTargetPackage(MODEL_PACKAGE);
        context.setJavaModelGeneratorConfiguration(javaModelGeneratorConfiguration);

        SqlMapGeneratorConfiguration sqlMapGeneratorConfiguration = new SqlMapGeneratorConfiguration();
        sqlMapGeneratorConfiguration.setTargetProject(PROJECT_PATH +BIZPROJECT+ JAVA_PATH);
        sqlMapGeneratorConfiguration.setTargetPackage(MAPPER_XML_PACKAGE);
        context.setSqlMapGeneratorConfiguration(sqlMapGeneratorConfiguration);

        JavaClientGeneratorConfiguration javaClientGeneratorConfiguration = new JavaClientGeneratorConfiguration();
        javaClientGeneratorConfiguration.setTargetProject(PROJECT_PATH  + BIZPROJECT + JAVA_PATH);
    ...
    public static void genService(String tableName, String modelName) {
        try {
            ...
            File file = new File(PROJECT_PATH + BIZPROJECT + JAVA_PATH + PACKAGE_PATH_SERVICE+ "I" + modelNameUpperCamel + "Service.java");
            ...
            File file1 = new File(PROJECT_PATH + BIZPROJECT+ JAVA_PATH + PACKAGE_PATH_SERVICE_IMPL + modelNameUpperCamel + "ServiceImpl.java");
    ...
    public static void genController(String tableName, String modelName) {
        try {
            ...
            File file = new File(PROJECT_PATH + BIZPROJECT + JAVA_PATH + PACKAGE_PATH_CONTROLLER + modelNameUpperCamel + "Controller.java");
            if (!file.getParentFile().exists()) {
                file.getParentFile().mkdirs();
            }
